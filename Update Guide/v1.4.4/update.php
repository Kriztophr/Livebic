            ...
            <div class="col-md-10">
               <div class="wo_install_wiz">
                 <?php if ($updated == false) { ?>
                  <div>
                     <h2 class="light">Update to v1.4.4 </span></h2>
                     <div class="setting-well">
                        <h4>Changelog</h4>
                        <ul class="wo_update_changelog">
                          <li>[Added] Google Drive Storage, now you can upload directly to your own drive account.</li>
...
<script>
var queries = [
    "UPDATE `config` SET value = '1.4.4' WHERE name = 'version';",
    "INSERT INTO `config` (`id`, `name`, `value`) VALUES (NULL, 'google_refreshToken', ''), (NULL, 'google_ClientId', '');",
    "INSERT INTO `config` (`id`, `name`, `value`) VALUES (NULL, 'google_ClientSecret', '');",
    "INSERT INTO `config` (`id`, `name`, `value`) VALUES (NULL, 'google_drive', 'off');",
];
