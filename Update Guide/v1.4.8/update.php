            ...
            <div class="col-md-10">
               <div class="wo_install_wiz">
                 <?php if ($updated == false) { ?>
                  <div>
                     <h2 class="light">Update to v1.4.8 </span></h2>
                     ...
                     <div class="setting-well">
                        ...
                        <ul class="wo_update_changelog">
                         ...
                         <li>[Added] custom endpoint (domain name) for S3, Spaces, Wasabi and Backblaze.</li>
                         <li>[Added] Backblaze storage. </li>
                         <li>[Added] the ability to upload files directly from admin panel to third party storages.</li>
...
<script>
var queries = [
    "UPDATE `config` SET value = '1.4.8' WHERE name = 'version';",
    "INSERT INTO `config` (`id`, `name`, `value`) VALUES (NULL, 'wasabi_storage', 'off'), (NULL, 'wasabi_bucket_name', ''), (NULL, 'wasabi_access_key', ''), (NULL, 'wasabi_secret_key', '');",
    "INSERT INTO `config` (`id`, `name`, `value`) VALUES (NULL, 'backblaze_storage', 'off'), (NULL, 'backblaze_bucket_id', ''), (NULL, 'backblaze_bucket_name', ''), (NULL, 'backblaze_region', ''), (NULL, 'backblaze_access_key_id', ''), (NULL, 'backblaze_access_key', '');",
    "INSERT INTO `config` (`id`, `name`, `value`) VALUES (NULL, 'amazon_endpoint', ''), (NULL, 'spaces_endpoint', ''), (NULL, 'backblaze_endpoint', ''), (NULL, 'wasabi_endpoint', '');",
    "CREATE TABLE `uploaded_media` ( `id` INT NOT NULL AUTO_INCREMENT , `filename` VARCHAR(200) NOT NULL DEFAULT '' , `time` INT NOT NULL DEFAULT '0' , PRIMARY KEY (`id`), INDEX (`filename`), INDEX (`time`)) ENGINE = InnoDB;",
    "ALTER TABLE `uploaded_media` ADD `storage` VARCHAR(34) NOT NULL AFTER `filename`;",
    "ALTER TABLE `uploaded_media` ADD INDEX( `filename`, `storage`);"
];
