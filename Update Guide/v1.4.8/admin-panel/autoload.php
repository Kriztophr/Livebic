        ...
        <div class="navigation">
            ...
            <div class="navigation-menu-body">
                <ul>
                    ...
                    <li>
                        <a <?php echo ($page == 'general-settings' || $page == 'push-notifications-system' || $page == 'site-settings' || $page == 'payment-settings' || $page == 'email-settings' || $page == 'social-login' || $page == 's3' || $page == 'upload-to-storage' || $page == 'import-settings') ? 'class="open"' : ''; ?> href="javascript:void(0);">
                            <span class="nav-link-icon">
