...
$music->site_content = loadPage("dashboard/content", [
	...
	'TOTAL_SONGS_PURCHAES' => number_format($TOTAL_SONGS_PURCHAES, 2),
	'TOTAL_TICKETS_PURCHAES' => number_format($TOTAL_TICKETS_PURCHAES, 2),
	'TOTAL_PRODUCTS_PURCHAES' => number_format($TOTAL_PRODUCTS_PURCHAES, 2),
	'TOTAL_SALES' => number_format(($TOTAL_PRODUCTS_PURCHAES + $TOTAL_SONGS_PURCHAES + $TOTAL_TICKETS_PURCHAES), 2),
	'TOTAL_SALES_THIS_WEEK' => number_format(($TOTAL_PRODUCTS_PURCHAES_MONTH + $TOTAL_SONGS_PURCHAES_MONTH + $TOTAL_TICKETS_PURCHAES_MONTH), 2),
	'TOTAL_SALES_TODAY' => number_format(($TOTAL_TICKETS_PURCHAES_TODAY + $TOTAL_SONGS_PURCHAES_TODAY + $TOTAL_PRODUCTS_PURCHAES_TODAY), 2),
