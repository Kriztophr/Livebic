...
if (empty($path['options'][2])) {
	...
	if (in_array($path['options'][2], ['general', 'profile', 'delete', 'password', 'blocked','interest','balance','withdrawals','notification', 'manage-sessions', 'two-factor', 'affiliates','my_info','invitation_links','wallet','addresses'])) {
