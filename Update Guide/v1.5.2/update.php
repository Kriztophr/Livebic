                  ...
                  <div>
                     ...
                     <div class="setting-well">
                        ...
                        <ul class="wo_update_changelog">
                          <li>[Added] plugin system, now developers can make plugins for DeepSound and keep your customizations after updates, <a href="https://docs.deepsoundscript.com/#plugins" target="blank">Read More</a> </li>
...
<script>
var queries = [
    "CREATE TABLE `plugins` ( `id` INT NOT NULL AUTO_INCREMENT , `name` VARCHAR(50) NOT NULL , `active` INT NOT NULL DEFAULT '0' , PRIMARY KEY (`id`), INDEX (`active`), INDEX (`name`)) ENGINE = InnoDB;",
    "ALTER TABLE `plugins` ADD UNIQUE(`name`);",
    "ALTER TABLE `plugins` ADD `version` VARCHAR(22) NOT NULL DEFAULT '1.0' AFTER `active`;"
];
